...
namespace ESourcing.Order.Consumers
{
    public class EventBusOrderCreateConsumer
    {
        ...
        public void Consume()
        {
            ...
            channel.QueueDeclare(queue: EventBusConstants.OrderCreateQuene, durable: false, exclusive: false, autoDelete: false, arguments: null);
            var consumer = new EventingBasicConsumer(channel);

            consumer.Received += ReceivedEvent;
            channel.BasicConsume( queue :EventBusConstants.OrderCreateQuene,autoAck:true,consumer: consumer );
        }
        private async void ReceivedEvent(object sender ,BasicDeliverEventArgs e)
        {
            ...
            if(e.RoutingKey == EventBusConstants.OrderCreateQuene)
            {
